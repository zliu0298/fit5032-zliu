  ...
  <div class="container">
    <header class="d-flex justify-content-center py-3">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <router-link to="/addbook" class="nav-link" active-class="active" aria-current="page">
            Add Book
          </router-link>
        </li>
        <li class="nav-item">
          <router-link to="/GetBookCount" class="nav-link" active-class="active" aria-current="page">
            Get Book Count
          </router-link>
        </li>
        <li class="nav-item">
          <router-link to="/WeatherCheck" class="nav-link" active-class="active" aria-current="page">
            Get Weather
          </router-link>
        </li>
        <li class="nav-item">
          <router-link to="/CountBookAPI" class="nav-link" active-class="active" aria-current="page">
            Count Book API
          </router-link>
        </li>
        <li class="nav-item">
